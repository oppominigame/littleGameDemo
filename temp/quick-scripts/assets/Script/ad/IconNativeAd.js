(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ad/IconNativeAd.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'a1dc28LHp9GWIpuCs7xzFPn', 'IconNativeAd', __filename);
// Script/ad/IconNativeAd.ts
...
var IconNativeAd = /** @class */ (function (_super) {
    __extends(IconNativeAd, _super);
    function IconNativeAd() {
    ...
    IconNativeAd.prototype.start = function () {
        var _this = this;
    ...
    // 回调信息展示
    IconNativeAd.prototype.log = function (msg, detail) {
        if (detail === void 0) { detail = ''; }
        console.log(msg + detail);
        this.logLabel.getComponent(cc.Label).string = msg;
    };
    IconNativeAd.prototype.showAd = function () {
        var _this = this;
        if (!this.adData)
            return;
        this.adLayout.active = true;
        var adImg = void 0, adLogo = void 0, adClose = void 0;
        adImg = this.adLayout.getChildByName('adImg');
        adLogo = this.adLayout.getChildByName('adLogo');
        adClose = this.adLayout.getChildByName('adClose');
        // 加载广告图片
        adImg.active = false;
        this.adData.iconUrlList &&
            this.adData.iconUrlList.length > 0 &&
            cc.loader.load(this.adData.iconUrlList[0], function (err, texture) {
                adImg.active = true;
        ...
        adImg.on(cc.Node.EventType.TOUCH_START, function () {
            // 点击广告按钮下载
    ...
    // 返回
    IconNativeAd.prototype.onClickReturnBtn = function () {
        cc.director.loadScene('nativeAd');
    };
    IconNativeAd.prototype.onDestroy = function () {
        if (!this.nativeAd)
            return;
        ...
        console.log('icon 521 x 521 原生广告销毁');
    };
    __decorate([
        property(cc.Button)
    ], IconNativeAd.prototype, "returnBtn", void 0);
    __decorate([
        property(cc.Node)
    ], IconNativeAd.prototype, "showBtn", void 0);
    __decorate([
        property(cc.Node)
    ], IconNativeAd.prototype, "loadBtn", void 0);
    __decorate([
        property(cc.Node)
    ], IconNativeAd.prototype, "destroyBtn", void 0);
    __decorate([
        property(cc.Node)
    ], IconNativeAd.prototype, "logLabel", void 0);
    __decorate([
        property(cc.Object)
    ], IconNativeAd.prototype, "nativeAd", void 0);
    __decorate([
        property(cc.Node)
    ], IconNativeAd.prototype, "adLayout", void 0);
    __decorate([
        property(cc.Object)
    ], IconNativeAd.prototype, "adData", void 0);
    IconNativeAd = __decorate([
        ccclass
    ], IconNativeAd);
    return IconNativeAd;
}(cc.Component));
exports.default = IconNativeAd;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=IconNativeAd.js.map
