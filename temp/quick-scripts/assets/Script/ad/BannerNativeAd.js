(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ad/BannerNativeAd.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5d3c1cgCdZDjrNPGjFVkFc7', 'BannerNativeAd', __filename);
// Script/ad/BannerNativeAd.ts
...
var SmallNativeAd = /** @class */ (function (_super) {
    __extends(SmallNativeAd, _super);
    function SmallNativeAd() {
    ...
    SmallNativeAd.prototype.start = function () {
        var _this = this;
    ...
    // 回调信息展示
    SmallNativeAd.prototype.log = function (msg, detail) {
        if (detail === void 0) { detail = ''; }
        console.log(msg + detail);
        this.logLabel.getComponent(cc.Label).string = msg;
    };
    SmallNativeAd.prototype.showAd = function () {
        var _this = this;
        if (!this.adData)
            return;
    ...
    // 返回
    SmallNativeAd.prototype.onClickReturnBtn = function () {
        cc.director.loadScene('nativeAd');
    };
    SmallNativeAd.prototype.onDestroy = function () {
        if (!this.nativeAd)
            return;
        ...
        console.log('banner 512 x 512 原生广告销毁');
    };
    __decorate([
        property(cc.Button)
    ], SmallNativeAd.prototype, "returnBtn", void 0);
    __decorate([
        property(cc.Node)
    ], SmallNativeAd.prototype, "showBtn", void 0);
    __decorate([
        property(cc.Node)
    ], SmallNativeAd.prototype, "loadBtn", void 0);
    __decorate([
        property(cc.Node)
    ], SmallNativeAd.prototype, "destroyBtn", void 0);
    __decorate([
        property(cc.Node)
    ], SmallNativeAd.prototype, "logLabel", void 0);
    __decorate([
        property(cc.Object)
    ], SmallNativeAd.prototype, "nativeAd", void 0);
    __decorate([
        property(cc.Node)
    ], SmallNativeAd.prototype, "adLayout", void 0);
    __decorate([
        property(cc.Object)
    ], SmallNativeAd.prototype, "adData", void 0);
    SmallNativeAd = __decorate([
        ccclass
    ], SmallNativeAd);
    return SmallNativeAd;
}(cc.Component));
exports.default = SmallNativeAd;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=BannerNativeAd.js.map
